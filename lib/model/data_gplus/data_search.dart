class AllUnits {
  ...
  factory AllUnits.fromJson(Map<String, dynamic> json) => AllUnits(
        ...
        data: json["data"],
        datas: List<AllUnitsData>.from(
            json["datas"].map((x) => AllUnitsData.fromJson(x))),
...
class HospitalDoctorClinicInfo {
  ...
  factory HospitalDoctorClinicInfo.fromJson(Map<String, dynamic> json) =>
      HospitalDoctorClinicInfo(
        isSuccess: json["is_success"],
        message: json["message"],
        data: json["data"],
        datas: List<HospitalDoctorClinic>.from(
            json["datas"].map((x) => HospitalDoctorClinic.fromJson(x))),
        totalRows: json["total_rows"],
        pageNumber: json["page_number"],
        rowsCount: json["rows_count"],
        totalPage: json["total_page"],
...
class HospitalDoctorClinic {
  ...
  factory HospitalDoctorClinic.fromJson(Map<String, dynamic> json) =>
      HospitalDoctorClinic(
        id: json["id"],
        type: json["type"],
