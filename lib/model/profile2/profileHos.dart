...
ProfileHos dataGplusFromJson(String str) => ProfileHos.fromJson(json.decode(str));

String dataGplusToJson(ProfileHos data) => json.encode(data.toJson());
...
class ProfileHos {
  ...
  factory ProfileHos.fromJson(Map<String, dynamic> json) => ProfileHos(
    ...
    units: Cities.fromJson(json["units"]),
    isFav: json["isFav"],
  );
...
class PurpleData {
  ...
  dynamic jobTitleId;
  dynamic genusId;
  List<Insurances> paymentMethods;
  ...
  factory PurpleData.fromJson(Map<String, dynamic> json) => PurpleData(
    ...
    paymentMethods: List<Insurances>.from(json["paymentMethods"].map((x) => Insurances.fromJson(x))),
    insurances: List<Insurances>.from(json["insurances"].map((x) => Insurances.fromJson(x))),
